...
plot_dir = r"C:\Users\hp\Desktop\DIP-G7\plots\vgg16_noisy"
...
checkpoint = ModelCheckpoint(
    filepath=os.path.join(model_dir, "VGG16_noisy_best.h5"),
    monitor='val_accuracy',
    save_best_only=True,
    verbose=1
)
...
plt.title("VGG16 Noisy Confusion Matrix")
...
plt.title("VGG16 Noisy Accuracy")
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
plt.legend()
...
model.save(os.path.join(model_dir, "VGG16_noisy_final.h5"))

print("\n===================================")
print("VGG16 NOISY MODEL TRAINING COMPLETED")
print("===================================")